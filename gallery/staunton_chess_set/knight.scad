...
module knight() scale(0.8975) {
    ...
    support(base=10, tip=7, from=[-22, 0], to=[-20, 0, 28], bottom=10);
    support(base=7, tip=[5, 7.5], from=[-20, 0, 28], to=[-13, 0, 39]);

    support(base=[5, 7.5], tip=[4.3, 7.5], from=[-13, 0, 39], to=[-15.05, 0, 42.5], top=0.8);
    support(base=[5, 7.5], tip=[5.6, 7.5], from=[-13, 0, 39], to=[-9.2, 0, 44], top=0.8);

    support_interface(base=[0.4, 7.5], from=[-17, 0, 42.5], to=[-17, 0, 45], count=4);
    support_interface(base=[0.4, 7.5], from=[-11.8, 0, 44], to=[-11.8, 0, 47], count=5);
  }
